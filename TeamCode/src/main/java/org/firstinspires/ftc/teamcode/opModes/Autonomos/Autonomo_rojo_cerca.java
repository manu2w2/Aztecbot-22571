...
public class Autonomo_rojo_cerca extends CommandOpMode {
    ...
    private final Pose startPose = new Pose(117.302, 126.059, Math.toRadians(126.5));
    ...
    public void buildPaths() {
        ...
        ciclo2part2 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(127.114, 64.402),
                                new Pose(97.471, 62.179),
                                new Pose(87.575, 82.888)
                        )
                )
