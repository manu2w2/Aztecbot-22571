...
@Autonomous(name = "Autonomo azul lejos 2", group = "Autonomous")
@Configurable
public class Autonomo_Rojo_lejos_2 extends CommandOpMode {
    private Follower follower;

    private final Pose startPose = new Pose(53.803, 9.112, Math.toRadians(0));

    // PathChains (sin cambiar nombres ni trayectorias)
    private PathChain ciclo1, ciclo2;
    ...
    public void buildPaths() {
        ...
        ciclo1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(53.803, 9.112),
                                new Pose(53.803, 18.285)
                        )
                )
    ...
    private SequentialCommandGroup createAutonomousSequence() {
        return new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        ...
                        new SpinUpShooterCommand(shooter,1510,20),
                        new SetHoodPositionCommand(hood,0.51),
                        new SetTurretPositionCommand(turret,-78),
                        new CloseTopeCommand(Tope)
                ),
                new WaitCommand(200),
                new ParallelCommandGroup(
                        new SetIntakeVelocityCommand(intake,1000),
