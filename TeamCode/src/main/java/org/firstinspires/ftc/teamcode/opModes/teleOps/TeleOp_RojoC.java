...
@Configurable
@TeleOp(name = "TELEOP_rojo_C_Optimized")
public class TeleOp_RojoC extends CommandOpMode {
    ...
    public void initialize() {
        ...
        new Trigger(() -> gamepad1.xWasPressed()).whenActive(new InstantCommand(() -> angle += 2.5));
        new Trigger(() -> gamepad1.bWasPressed()).whenActive(new InstantCommand(() -> angle -= 2.5));
    }
